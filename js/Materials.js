// Whatever program we use + uniforms
// Needs to know which uniforms, and finds only the active uniforms in the shader
// Want materials to reflect properties of the uniforms
